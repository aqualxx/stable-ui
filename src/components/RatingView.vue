...
<template>
    ...
    <div v-if="optionsStore.apiKey === '0000000000' || optionsStore.apiKey === ''">You must <BaseLink href="https://aqualxx.github.io/stable-ui/options">sign in</BaseLink> using your API key to start rating images.</div>
    <div v-else>
        <div>From rating a total of <strong>{{ ratingStore.imagesRated }}</strong> images, you have gained <strong>{{ ratingStore.kudosEarned }}</strong> kudos!</div>
        <el-button
